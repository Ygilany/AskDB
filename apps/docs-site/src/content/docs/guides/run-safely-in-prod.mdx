...
- **Strict** — set `ASKDB_OMIT_SENSITIVE_FROM_PROMPT=true` to omit sensitive columns from the prompt entirely. The model can't propose them because it doesn't know they exist.
