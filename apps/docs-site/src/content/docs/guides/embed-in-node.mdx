...
The full working package (with `package.json`, `tsconfig.json`, and `.env` instructions) lives in [`examples/express-server`](https://github.com/askdb/askdb/tree/main/examples/express-server) in the repo.
