---
title: "@askdb/rag"
description: "The RAG package turns enriched Schema v2 artifacts into deterministic chunks, indexes them with your embedder and vector store, and returns a retriever for @askdb/core."
---

<p className="doc-eyebrow">Schema retrieval</p>

<p className="doc-lede">The RAG package turns enriched Schema v2 artifacts into deterministic chunks, indexes them with your embedder and vector store, and returns a retriever for @askdb/core.</p>

## When to use

<ul>
  <li>Your Schema v2 artifact is <strong>too large</strong> to fit comfortably in every prompt.</li>
  <li>You want retrieval over the <strong>same</strong> describable schema—not a forked knowledge base—see <a href="../guides/rag-large-schema/">Add RAG for large schemas</a>.</li>
</ul>
