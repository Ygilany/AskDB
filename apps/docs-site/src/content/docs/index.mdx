...
<div className="link-cards">
            <a href="./environment/"><strong>Configure environment</strong><span>Load <code>{".env"}</code> and optional <code>{"askdb.config.ts"}</code> for friendly secret names.</span></a>
