...
<ul>
  <li>You target <strong>PostgreSQL</strong> for NL→SQL validation and prompts (<code>{"postgresDialect"}</code>).</li>
  <li>You introspect a live Postgres instance or consume catalog SQL templates / export bundles.</li>
</ul>
