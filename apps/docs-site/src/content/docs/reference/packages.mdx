...
| Symbol | Purpose |
| --- | --- |
| `createAskDbAiRegistry` | Register provider adapters and build language or embedding models. |
...
Provider adapters own concrete AI SDK provider dependencies:
...
| `@askdb/ai-openai`, `@askdb/ai-azure`, `@askdb/ai-google` | `@askdb/ai` + the matching AI SDK provider package |
