...
Generating SQL in Studio does not require a database driver. The optional execute action that runs generated SQL against Postgres requires `pg` in the project running Studio:
