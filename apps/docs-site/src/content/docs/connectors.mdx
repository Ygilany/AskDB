...
<p>
  Long-form notes and recipes also live in{" "}
  <a href="https://github.com/Ygilany/AskDB/blob/main/docs/integration/connectors.md">docs/integration/connectors.md</a>.
</p>
