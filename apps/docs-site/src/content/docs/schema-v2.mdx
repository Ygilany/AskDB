...
<p>
  Authoritative contract (field names, validation, bundling):{" "}
  <a href="https://github.com/Ygilany/AskDB/blob/main/docs/contracts/schema-v2.md">docs/contracts/schema-v2.md</a>.
</p>
