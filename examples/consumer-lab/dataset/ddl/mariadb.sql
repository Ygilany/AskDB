-- AskDB consumer lab: MariaDB 11.4 DDL. Implements dataset/schema.logical.json.
-- Starts as a copy of mysql.sql; kept separate so MariaDB-specific drift stays visible.
-- MariaDB has no schemas inside a database, and AskDB's MySQL connector introspects only
