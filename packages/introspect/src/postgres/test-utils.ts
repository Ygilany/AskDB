...
import type { SqlTemplate, SqlTemplateName } from "../types.js";
import { POSTGRES_TEMPLATES } from "./templates.js";

export type CatalogSnapshot = Partial<
  Record<SqlTemplateName, ReadonlyArray<Record<string, unknown>>>
>;
