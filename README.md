...
>
> **Status:** 0.x. The core API (`ask()`), schema artifact, and config are stable and documented; Studio and RAG may still change in minor releases before 1.0. AskDB returns SQL for review; it does not execute generated SQL.
